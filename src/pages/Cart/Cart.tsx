      ...
      <div className={styles.cartContainer}>
        ...
        <div className={styles.emptyCart}>
          <div>
            ...
            <p className={styles.emptyCartText}>Add some programs to get started on your fitness journey!</p>
                  ...
                  {cartItems.map((item) => (
                    <div key={item.id} className={styles.cartItem}>
                      ...
                      <div className={styles.cartItemDetails}>
                        ...
                        {item.duration && (
                          <p className={styles.cartItemMeta}>Duration: {item.duration}</p>
                        )}
                        {item.level && (
                          <p className={styles.cartItemMeta}>Level: {item.level}</p>
                        )}
                      ...
                      <div className={styles.cartItemQuantity}>
                        ...
                        <span className={styles.cartItemQuantityValue}>{item.quantity}</span>
                        <button
                          onClick={() => updateQuantity(item.id, item.quantity + 1)}
                          className={styles.cartItemQuantityButton}
                        >
