  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Discover the most effective exercises to build a strong, stable core that will improve your overall fitness performance.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Learn what to eat before and after your workouts to maximize performance and recovery.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Practical tips and strategies to maintain motivation and consistency in your fitness routine.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Understanding the physiological benefits of High-Intensity Interval Training and how to implement it effectively.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Learn how to create sustainable lifestyle changes that will support your long-term health and fitness goals.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Why recovery is just as important as training and how to optimize your rest days for better results.",
      image:
      ...
      <section className={styles.blogHero}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className={styles.blogHeroSubtitle}>
            Expert insights, tips, and guides to help you on your fitness
            journey.
          </p>
        </div>
      </section>
              ...
              >
                ...
                <div className={styles.blogPostContent}>
                  ...
                  <button className={styles.blogPostReadMore}>
                    <span>Read More</span>
                    <ArrowRight
                      className={`${styles.blogPostReadMoreIcon} h-4 w-4`}
                    />
                  </button>
                </div>
              </article>
      ...
      <section className={styles.blogNewsletter}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className={styles.blogNewsletterText}>
            Subscribe to our newsletter and never miss out on expert fitness
            tips and insights.
          </p>
