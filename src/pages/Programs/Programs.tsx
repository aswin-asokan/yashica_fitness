...
const Programs = () => {
  const { addToCart } = useCart();
    ...
    const programs = [
    {
      ...
      description: 'Build lean muscle mass and increase your overall strength with our progressive resistance training program.',
    ...
    },
    {
      ...
      description: 'Lose weight effectively with our comprehensive program combining cardio, strength training, and nutrition.',
    ...
    },
    {
      ...
      description: 'Enhance your athletic performance with sport-specific training protocols and advanced techniques.',
    ...
    },
    {
      ...
      description: 'Get fit at home with minimal equipment. Perfect for busy schedules and beginners.',
    ...
    },
    {
      ...
      description: 'Strengthen your core and improve flexibility with yoga-inspired movements and targeted exercises.',
    ...
    },
    {
      id: 6,
      name: 'Senior Fitness',
      description: 'Safe and effective fitness program designed specifically for active adults 55+.',
      ...
      <section className={styles.programsHero}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className={styles.programsHeroSubtitle}>
            Choose from our scientifically-designed programs to achieve your specific fitness goals.
          </p>
        </div>
      </section>
                  ...
                  <ul className={styles.programFeatures}>
                    {program.features.map((feature, index) => (
                      <li key={index} className={styles.programFeature}>
                        <Check className={`${styles.programFeatureIcon} h-4 w-4`} />
                        <span>{feature}</span>
                      </li>
                    ))}
                  </ul>
      ...
      <section className={styles.programsCta}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className={styles.programsCtaText}>
            Our fitness experts can create a custom program tailored specifically to your goals, 
